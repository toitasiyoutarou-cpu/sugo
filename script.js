const battles = [
  {
    ...
    hp:200,
    baseData:["NaHCO₃=84","NaOH=40","Na₂CO₃=106","Na₂O=62","H₂O=18","CO₂=44"],
    questions:[
      {tag:"物質量", focus:"", q:"NaHCO₃を8.4g加熱した。NaHCO₃の物質量は？", a:"0.10 mol", choices:["0.10 mol","1.0 mol","0.084 mol","8.4 mol"], exp:"NaHCO₃の式量は84。8.4÷84=0.10mol。"},
      {tag:"理論値", focus:"今回考える反応式：<br>(b) 2NaHCO₃ → Na₂CO₃ + H₂O + CO₂", q:"この式の場合、0.10molのNaHCO₃からNa₂CO₃は何molできる？", a:"0.050 mol", choices:["0.050 mol","0.10 mol","0.20 mol","0.0050 mol"], exp:"係数比は NaHCO₃:Na₂CO₃=2:1。0.10molの半分、0.050molのNa₂CO₃ができる。"},
      {tag:"質量", focus:"今回考える反応式：<br>(b) 2NaHCO₃ → Na₂CO₃ + H₂O + CO₂", q:"0.050molのNa₂CO₃の質量は？", a:"5.3 g", choices:["5.3 g","10.6 g","4.0 g","6.2 g"], exp:"0.050×106=5.3g。実験値と近いなら、(b)を支持する証拠になる。"},
      {tag:"考察", focus:"実験値と理論値を比較せよ！", q:"質量の比較だけで反応式を考えるとき、一番大切なのはどれ？", a:"候補ごとの理論値と実測値を比べること", choices:["候補ごとの理論値と実測値を比べること","見た目の色だけで判断すること","加熱時間だけで決めること","気体が出たら全部同じ反応と考えること"], exp:"候補ごとの理論値を計算し、実測値と比較することで、実験データが証拠になる。"},
      {tag:"FINAL", focus:"(a) NaHCO₃ → NaOH + CO₂<br>(b) 2NaHCO₃ → Na₂CO₃ + H₂O + CO₂<br>(c) 2NaHCO₃ → Na₂O + H₂O + 2CO₂", q:"結論として、実験で残った白色固体の質量が約5.3gだった。最も適切な化学反応式はどれ？", a:"(b) 2NaHCO₃→Na₂CO₃+H₂O+CO₂", choices:["(a) NaHCO₃→NaOH+CO₂","(b) 2NaHCO₃→Na₂CO₃+H₂O+CO₂","(c) 2NaHCO₃→Na₂O+H₂O+2CO₂"], exp:"実測値約5.3gと理論値が一致するのは(b)。よって、2NaHCO₃→Na₂CO₃+H₂O+CO₂ と考えられる。", final:true}
    ]
  },
  {
    title:"第2戦：CaCO₃ゴーレム",
    ...
    hp:280,
    baseData:["CaCO₃=100","HCl=36.5","CaCl₂=111","CO₂=44","H₂O=18","20.0mL=0.0200L"],
    questions:[
      {tag:"原点", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O", q:"CaCO₃をまったく加えないとCO₂は発生しない。このとき近似線は？", a:"原点(0,0)を通る線として考える", choices:["原点(0,0)を通る線として考える","原点を通らない線にする","横軸と平行な線にする","グラフは描けない"], exp:"CaCO₃が0ならCO₂も0。最初の直線部分は原点を通ると考えるのが自然。"},
      {tag:"モデル", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O", q:"CaCO₃を増やすとCO₂は最初増えるが、途中から増えなくなる。最も適切なモデルは？", a:"二本の直線で近似する", choices:["二本の直線で近似する","一本の曲線で近似する","最後まで一本の直線で増え続ける","点を結ばず考えない"], exp:"最初はCaCO₃が不足。途中からHClが不足し、CO₂発生量が頭打ちになる。"},
      {tag:"折れ曲がり", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O", q:"CO₂の発生量が途中から増えなくなる理由は？", a:"HClが不足し、CaCO₃を増やしても反応が進まなくなるから", choices:["HClが不足し、CaCO₃を増やしても反応が進まなくなるから","CaCO₃が途中で増えなくなるから","CO₂の式量が変わるから","反応式の係数が途中で変わるから"], exp:"相手であるHClが不足すると、CaCO₃を増やしても反応は進まない。"},
      {tag:"交点", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O", q:"グラフの折れ曲がる点・交点は何を意味する？", a:"HClとCaCO₃が過不足なく反応する点", choices:["HClとCaCO₃が過不足なく反応する点","反応が始まる点","CO₂が水に全部溶けた点","測定ミスだけを表す点"], exp:"交点はHClがちょうど使い切られる点。ここから濃度計算へ進める。"},
      {tag:"CaCO₃量", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O", q:"3.0gのCaCO₃の物質量は？", a:"0.030 mol", choices:["0.030 mol","0.30 mol","0.015 mol","0.060 mol"], exp:"CaCO₃=100なので、3.0÷100=0.030mol。"},
      {tag:"HCl量", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O", q:"CaCO₃が0.030mol過不足なく反応した。HClの物質量は？", a:"0.060 mol", choices:["0.060 mol","0.030 mol","0.015 mol","0.090 mol"], exp:"CaCO₃:HCl=1:2。CaCO₃が0.030molなら、HClは0.060mol。"},
      {tag:"FINAL", focus:"CaCO₃ + 2HCl → CaCl₂ + CO₂ + H₂O<br>3.0gのCaCO₃と過不足なく反応した塩酸は20.0mL", q:"3.0gの炭酸カルシウムと過不足なく反応した20.0mLの塩酸のモル濃度は？", a:"3.0 mol/L", choices:["1.5 mol/L","2.0 mol/L","3.0 mol/L","6.0 mol/L"], exp:"3.0gのCaCO₃は0.030mol。HClは係数比より0.060mol。20.0mL=0.0200Lなので、M=0.060÷0.0200=3.0mol/L。", final:true}
    ]
  }
];
...
function loadQuestion(){
  ...
  document.getElementById("dataBox").innerHTML=b.baseData.map(x=>`<div>${x}</div>`).join("");
  const focus=document.getElementById("focusBox");
  if(q.focus){ focus.innerHTML=q.focus; focus.classList.add("show"); } else { focus.innerHTML=""; focus.classList.remove("show"); }
